export default function PremiumMetalNamePens() {
  ...
  {
    title: "Print Quality",
    desc: "We use advanced dye and pigment-based inks to deliver sharpest print possible with no color banding, no missing dots, and no streaks.",
    image: "https://picsum.photos/seed/magnet1/600/450",
  },
  {
    title: "Strong Magnets",
    desc: "Our magnets are strong and hold firmly to any magnetic surface. Perfect for refrigerators and metal boards.",
    image: "https://picsum.photos/seed/magnet2/600/450",
  },
  {
    title: "Perfect Shapes",
    desc: "Available in multiple shapes to give your memories a unique and eye-catching look.",
    image: "https://picsum.photos/seed/magnet3/600/450",
  },
],
  ...
  <div className="grid grid-cols-1 gap-10">
    ...
    {product.details.map((d, i) => (
      ...
      >
        ...
        {/* TEXT */}
        <div
          className={`bg-blue-50 rounded-2xl p-10 h-full flex flex-col justify-center ${
            i % 2 === 0 ? "md:order-2" : "md:order-1"
          }`}
        >
          <h3 className="text-xl font-bold text-theme-color-2 mb-4">
            {d.title}
          </h3>
